...
function Idea({ n, title, children, link }: { n: string; title: string; children: ReactNode; link: [string, string] }) {
  return (
  ...
  return (
    <div className="min-h-dvh bg-ground">
      <AppBar
        ...
        status={<span>how it works</span>}
      />
      <main className="mx-auto max-w-[860px] px-6 pt-10 pb-24">
        ...
        <Idea n="01" title="ENS holds the terms, Hedera settles, The Graph is the product" link={["The three layers", "/#how"]}>
        ...
        <Idea n="02" title="Arithmetic decides what is allowed; the model decides what is worth it" link={["The agent", `${REPO}#the-agent`]}>
        ...
        <Idea n="03" title="An operator can reprice, not redirect" link={["What is enforced", "/docs/list-a-service#rules"]}>
        ...
        <Idea n="04" title="Discovery runs on resolver recovery" link={["Why, with measurements", `${REPO}#discovery-runs-on-resolver-recovery-not-on-the-event-log`]}>
        ...
        <Idea n="05" title="&ldquo;Paid&rdquo; is a heuristic when settlement fails" link={["The error taxonomy", `${REPO}/tree/main/packages/sdk#errors-are-typed-because-you-have-to-tell-them-apart`]}>
